...
FLAGS_DEF = utils.define_flags_with_default(
    ...
    project_config_name='BrainstormingExplore_experiment_linear_trad_alt1_v1_what',
...
def main(argv):
    ...
    print("Length of y_what:", len(test_dataset.data.y_what), "Length of x: ", len(test_dataset.data.x))
    print(train_dataset.data.x)
